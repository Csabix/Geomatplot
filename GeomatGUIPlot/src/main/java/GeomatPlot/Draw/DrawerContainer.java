...
public class DrawerContainer {
    private static final DrawableType[] values = DrawableType.values(); // Caching
    ...
    public Drawer getDrawer(DrawableType type) {
        return drawers[type.ordinal()];
    }
}
