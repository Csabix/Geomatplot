function retFunc = GetDefinedCallback(name, inputs, ownerLabel)
    switch name
        case 'makeDraggable'
            ...
            "function getMousePosition(evt) {let CTM = matrix;return {x: (evt.clientX - CTM.e) / CTM.a,y: (evt.clientY - CTM.f) / CTM.d};}}\n";
        ...
        case 'dragScreen'
            ...
            retFunc = "document.addEventListener('contextmenu', event => {event.preventDefault();});\n" + ...
                ...
                "svgCanvas.addEventListener('pointerdown', function (event) {if(event.button !== 2){return;}\n" + ...
