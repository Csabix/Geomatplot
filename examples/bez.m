...
Curve(b0,b1,b2,@(t,b0,b1,b2) b0.*(1-t).^2 + 2*b1.*t.*(1-t) + b2.*t.^2,'r:');
...
a = (b0-b1)+(b2-b1);
Vector(b1,b1+a);
fb0 = Mirror(b0 + a,PerpendicularLine(b0,b1,':'),'LabelVisible','off','MarkerSize',5);
fb2 = Mirror(b2 + a,PerpendicularLine(b2,b1,':'),'LabelVisible','off','MarkerSize',5);
